        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-2xl transition-transform group-hover:scale-110 pointer-events-none relative z-10 ${isActive ? "drop-shadow-md" : "opacity-70 group-hover:opacity-100"}`}>{item.icon}</span>
