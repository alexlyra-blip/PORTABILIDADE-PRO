export const inssBanks = [
  ...
  { value: "079", label: "079 - PICPAY" }, { value: "643", label: "643 - BANCO PINE" }, { value: "081", label: "081 - BANCO SEGURO" },
  { value: "041", label: "041 - BANRISUL" }, { value: "268", label: "268 - BARIGUI" }, { value: "318", label: "318 - BMG" },
  { value: "237", label: "237 - BRADESCO S.A." }, { value: "070", label: "070 - BRB" }, { value: "925", label: "925 - BRB CRÉDITO" }, { value: "626", label: "626 - C6 CONSIGNADO" },
  { value: "320", label: "320 - CCB BRASIL" }, { value: "104", label: "104 - CAIXA" }, { value: "069", label: "069 - CREFISA" },
  { value: "707", label: "707 - DAYCOVAL" }, { value: "335", label: "335 - DIGIO" }, { value: "149", label: "149 - FACTA" }, { value: "935", label: "935 - FACTA FINANCEIRA" },
