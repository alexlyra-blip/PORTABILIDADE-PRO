          ...
          <div className="hidden lg:col-span-7 lg:flex flex-col justify-center px-8 xl:px-12 text-left w-full h-full select-none relative">
            ...
            <div className="flex items-center justify-between gap-6 mb-3">
              ...
              <div className="flex-1 relative h-[270px] xl:h-[300px] flex items-end justify-center overflow-visible pr-8">
                ...
                <img 
                  src="/clara_login.png" 
                  alt="Clara - Atendente Virtual" 
                  className="h-full w-auto object-contain relative z-10 select-none pointer-events-none drop-shadow-2xl scale-110 translate-y-4" 
                />
            ...
            <div className="grid grid-cols-3 gap-4 w-full max-w-xl relative z-20">
              {/* IA */}
