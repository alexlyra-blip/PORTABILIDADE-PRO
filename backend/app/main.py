...
from app.routers import card_sales
from app.routers import card_sale_authorizations
...
app.include_router(
    card_sales.router,
    prefix="/api/card-sales",
    tags=["Card Sales"],
)
app.include_router(
    card_sale_authorizations.router,
    prefix="/api/card-sales",
    tags=["Card Sale Authorizations"],
)
app.include_router(
